...
object TestDataGenerator extends KoutaJsonFormats with Logging {
  ...
  private def koulutusNimi(i: Int) = shuffle(List[Kielistetty](Map(Fi -> s"Koulutus $i", Sv -> s"Koulutus $i sv"),
