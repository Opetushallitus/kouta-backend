...
trait KoutaIntegrationSpec
  ...
  val mockKayttooikeusClient: MockKayttooikeusClient = new MockKayttooikeusClient
...
trait DefaultKoodistoMocks extends KoodistoServiceMock {
  def addDefaultKoodistoMockResponsesForKoulutus(): Unit = {
    ...
    mockKoulutusKoodiUritForEPerusteResponse(12L, None, None, Seq("koulutus_371101"))
    mockKoulutusKoodiUritForEPerusteResponse(15L, None, None, Seq("koulutus_371101"))
  ...
  def addDefaultKoodistoMockResponsesForToteutus(): Unit = {
    ...
    mockKoodistoResponse("taiteenperusopetustaiteenala", Seq(("taiteenperusopetustaiteenala_kuvataide", 1, None)))
  }
