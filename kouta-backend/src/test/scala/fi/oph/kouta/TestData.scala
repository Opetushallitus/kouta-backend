...
object TestData {
  ...
  val AmmTutkinnonOsaValintaperusteMetadata: AmmatillinenTutkinnonOsaValintaperusteMetadata =
  ...
  val AmmOsaamisalaValintaperusteMetadata: AmmatillinenOsaamisalaValintaperusteMetadata =
  ...
  val TuvaValintaperusteMetadata: TutkintokoulutukseenValmentavaValintaperusteMetadata =
