...
class AmmatillinenKoulutusServiceValidationSpec extends BaseSubServiceValidationSpec[Koulutus] {
  ...
  override def validator = new AmmatillinenKoulutusServiceValidation(cachedKoodistoClient, ePerusteKoodiClient)
  ...
  override def beforeEach(): Unit = {
    ...
    when(cachedKoodistoClient.getKoodiUriVersionOrLatestFromCache("koulutus_371101#1"))
    ...
    when(cachedKoodistoClient.getKoodiUriVersionOrLatestFromCache("koulutus_371101#12"))
    ...
    when(cachedKoodistoClient.getKoodiUriVersionOrLatestFromCache("koulutus_371666#1"))
