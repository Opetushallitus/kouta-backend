...
class CachedKoodistoClientSpec extends SpecWithMocks with KoodistoServiceMock {
  ...
  "Getting latest version of koodiUri" should "return version from cache" in {
    ...
    koodiClient.getKoodistoElementVersionOrLatestFromCache("koulutus_201101") should equal(Right(TestKoodistoElement("koulutus_201101", 12, defaultNimi)))
    clearServiceMocks()
  ...
  "Getting certain version of koodiUri" should "return version from cache" in {
    ...
    koodiClient.getKoodistoElementVersionOrLatestFromCache("koulutus_201102#11") should equal(
  ...
  "When cache data is expired or removed" should "data fetched to cache again" in {
    ...
    koodiClient.getKoodistoElementVersionOrLatestFromCache("kansallinenkoulutusluokitus2016koulutusalataso1_01") should equal(
  ...
  "Finding hakukohdeKoodiUri" should "return true when koodiUri exists" in {
    ...
    koodiClient.koodiUriExistsInKoodisto(
  ...
  "Finding pohjakoulutusVaatimusKoodiUri" should "return true when koodiUri exists" in {
    ...
    koodiClient.koodiUriExistsInKoodisto(PohjakoulutusvaatimusKoodisto, "pohjakoulutusvaatimuskouta_pk") should equal(
      itemFound
    )
    koodiClient.koodiUriExistsInKoodisto(PohjakoulutusvaatimusKoodisto, "pohjakoulutusvaatimuskouta_yo#2") should equal(
      itemFound
    )
    koodiClient.koodiUriExistsInKoodisto(PohjakoulutusvaatimusKoodisto, "pohjakoulutusvaatimuskouta_XX") should equal(
      itemNotFound
    )
    koodiClient.koodiUriExistsInKoodisto(PohjakoulutusvaatimusKoodisto, "pohjakoulutusvaatimuskouta_YY") should equal(
      itemNotFound
    )
  }
  ...
  "Finding haunkohdejoukonTarkenneKoodiUri" should "return true when koodiUri exists" in {
    ...
    koodiClient.koodiUriExistsInKoodisto(HaunKohdejoukonTarkenneKoodisto, "haunkohdejoukontarkenne_1") should equal(
      itemFound
    )
    koodiClient.koodiUriExistsInKoodisto(HaunKohdejoukonTarkenneKoodisto, "haunkohdejoukontarkenne_2#2") should equal(
      itemFound
    )
    koodiClient.koodiUriExistsInKoodisto(HaunKohdejoukonTarkenneKoodisto, "haunkohdejoukontarkenne_6") should equal(
      itemNotFound
    )
    koodiClient.koodiUriExistsInKoodisto(HaunKohdejoukonTarkenneKoodisto, "haunkohdejoukontarkenne_9") should equal(
      itemNotFound
    )
  }
