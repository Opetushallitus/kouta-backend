...
import fi.oph.kouta.validation.Validations.{and, assertInFuture, assertNotOptional, assertTrue, cannotLinkToHakukohde, tyyppiMismatch, validateDependency, validateIfDefined, validateIfJulkaistu, validateIfTrue}
