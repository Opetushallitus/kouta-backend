...
class KoulutusServiceValidation(
  ...
  private def validateMetadata(koulutus: Koulutus, validationContext: ValidationContext, koulutusDiffResolver: KoulutusDiffResolver): IsValid = {
        ...
        validateIfNonEmpty[Lisatieto](
          ...
          (lisatieto, path) =>
            validateIfSuccessful(
              lisatieto.validate(validationContext.tila, validationContext.kielivalinta, path),
  ...
  private def validateMetadataSpecificParameters(
    ...
    koulutus.metadata.get match {
      ...
      case m: KkOpintokokonaisuusKoulutusMetadata =>
        and(
          assertKoulutusalaKoodiUrit(koulutusDiffResolver.newKoulutusalaKoodiUrit(), validationContext),
          validateOpintojenLaajuusyksikko(koulutusDiffResolver.newOpintojenLaajuusyksikkoKoodiUri(), false, validationContext),
  ...
  private def assertOpintojenLaajuusyksikkoKoodiUri(koodiUri: Option[String], validationContext: ValidationContext): IsValid =
    validateIfDefined[String](
      koodiUri,
      uri =>
        validateIfSuccessful(
  ...
  private def validateOpintojenLaajuusyksikko(
    ...
    and(
      assertOpintojenLaajuusyksikkoKoodiUri(koodiUri, validationContext),
      validateIfTrue(
        mandatoryIfJulkaistu,
        validateIfJulkaistu(
          validationContext.tila,
