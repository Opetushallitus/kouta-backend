    ...
    (
      { case s: JObject =>
        ...
        Try(s \ "tyyppi").toOption.collect { case JString(tyyppi) =>
          ...
          case VapaaSivistystyoOsaamismerkki => s.extract[VapaaSivistystyoOsaamismerkkiKoulutusMetadataRaporttiItem]
          ...
          case Muu                           => s.extract[MuuKoulutusMetadataRaporttiItem]
          case kt                            => throw new UnsupportedOperationException(s"Unsupported koulutustyyppi $kt")
        }
      },
    ...
    (
      { case s: JObject =>
        ...
        Try(s \ "tyyppi").toOption.collect { case JString(tyyppi) =>
          ...
          case VapaaSivistystyoOsaamismerkki => s.extract[VapaaSivistystyoOsaamismerkkiToteutusMetadataRaporttiItem]
