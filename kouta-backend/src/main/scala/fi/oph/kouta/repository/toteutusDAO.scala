...
trait ToteutusDAO extends EntityModificationDAO[ToteutusOid] {
  ...
  def getByKoulutusOid(koulutusOid: KoulutusOid, myosPoistetut: Boolean = false): Seq[Toteutus]
...
object ToteutusDAO extends ToteutusDAO with ToteutusSQL {
  ...
  override def getByKoulutusOid(koulutusOid: KoulutusOid, myosPoistetut: Boolean = false): Seq[Toteutus] = {
    KoutaDatabase.runBlockingTransactionally(
      for {
        toteutukset <- selectToteutuksetByKoulutusOid(koulutusOid, myosPoistetut).as[Toteutus]
