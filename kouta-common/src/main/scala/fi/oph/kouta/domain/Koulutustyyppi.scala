...
object Koulutustyyppi extends Enum[Koulutustyyppi] {
  ...
  def values = List(Amm, Lk, Muu, Yo, Amk, Tuva, Telma, AmmTutkinnonOsa, AmmOsaamisala)
  ...
  val oppilaitostyyppi2koulutustyyppi: Map[String, Seq[Koulutustyyppi]] = Map(
    ...
    "oppilaitostyyppi_21#1" -> Seq(Amm, Tuva, Telma), //Ammatilliset oppilaitokset
    ...
    "oppilaitostyyppi_63#1" -> Seq(Amm, Muu, Tuva, Telma), //Kansanopistot
    "oppilaitostyyppi_64#1" -> Seq(Muu, Tuva, Telma), //Kansalaisopistot
